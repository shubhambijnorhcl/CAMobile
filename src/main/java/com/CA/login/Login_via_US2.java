...
public class Login_via_US2 {
	
	TestBase obj=new TestBase();

	public AppiumDriver driver;
	//public IOSDriver driver;
	public Login_via_US2(AppiumDriver driver) {
...
//
	...
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeOther[@name=\"main\"]/XCUIElementTypeOther[15]/XCUIElementTypeTextField")
	public WebElement username;
	
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeOther[@name=\"main\"]/XCUIElementTypeOther[17]/XCUIElementTypeSecureTextField")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"SOMETHING WENT WRONG\"`]")
	public WebElement Login_error_page;
	
	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeButton[`label == \"Log in\"`]")
	public WebElement Login_error_login_page;
	...
	public void loginclick() throws Exception {
	 ...
	 public void logintest(String uname) { 
		 //Login_error_login_page.click();
		  username.sendKeys(uname);
		 // password.sendKeys(pwd);
		  password.sendKeys(obj.decodeString(con.Getpassword()));
		  }
